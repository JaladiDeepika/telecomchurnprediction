...
```{r}
#for(i in 10:15){churn_clean[,i] <- as.factor(mapvalues(churn_clean[,i],from= c("No internet service"), to= c("No")))}
```
...
```{r}
# Train
#confusionMatrix(as.factor(tr_pred2),as.factor(dtrain$Churn),positive = "Yes")
```
